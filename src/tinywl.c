...
static void output_frame(struct wl_listener *listener, void *data) {
	/* This function is called every time an output is ready to wl_display a frame,
...
static void server_new_output(struct wl_listener *listener, void *data) {
	/* This event is raised by the backend when a new output (aka a wl_display or
	 ...
	 * wl_display, which Wayland clients can see to find out information about the
...
static void xdg_toplevel_map(struct wl_listener *listener, void *data) {
	/* Called when the surface is mapped, or ready to wl_display on-screen. */
...
int main(int argc, char *argv[]) {
	...
	struct tinywl_server server;
	/* The Wayland wl_display is managed by libwayland. It handles accepting
	...
	/* Add a Unix socket to the Wayland wl_display. */
